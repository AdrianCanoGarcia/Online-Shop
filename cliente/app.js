...
template.pages = [
  {name: 'Single', hash: 'one', content: 'Single'},
  {name: 'page', hash: 'two', content: 'page'},
  {name: 'app', hash: 'three', content: 'app'},
  {name: 'using', hash: 'four', content: 'using'},
  {name: 'Polymer', hash: 'five', content: 'Polymer'}
];
